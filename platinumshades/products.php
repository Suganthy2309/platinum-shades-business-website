...
<title>Platinum Shades - Products</title>
</head>
    ...
    <div class="container-fluid container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 style="margin-top:-20px;">_____________</h4>
                <div class="seprator">
                </div>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                    industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type
                    and scrambled it to make a type specimen book. It has survived not only five centuries, but also the
                    leap into electronic typesetting, remaining essentially unchanged. It is a long established fact
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="productimage imageone">
                    <button type="button" class="btn btn-info productviewmore">VIEW MORE</button>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="productimage imagetwo">
                    <button type="button" class="btn btn-info productviewmore">VIEW MORE</button>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="productimage imagethree">
                    <button type="button" class="btn btn-info productviewmore">VIEW MORE</button>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div>
                    <button type="button" class="btn btn-info productsviewmore">VIEW MORE</button>
                </div>
            </div>
            <div class="col-sm-4">
            </div>
